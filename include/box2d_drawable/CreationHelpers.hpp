...
static inline DrawableRectangle CreateDrawableRectangle(sf::Vector2f& pos, sf::Vector2f &size, b2Body* body) {
    b2PolygonShape b2shape;
    DrawableRectangle drawableShape(pos, size, b2shape, body);
